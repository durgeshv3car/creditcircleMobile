...
const TaxCalculatorScreen = () => {
  ...
  const [form, setForm] = useState({
    ...
    deduction80E: '',
    deduction80CCD1B: '',
    // deduction80CCD2: '', // not used in calc, kept commented
    // deduction80EEA: '',
    deduction80TTA: '',
    deduction80G: '',
    deduction80U: '',
  ...
  const totalDeductionsOld =
    deduction80C + deduction80D + deduction80CCD1B + standardDeductionOld;
  const taxableIncomeOld = Math.max(grossIncome - totalDeductionsOld, 0);
  ...
  // Surcharge old
  let surchargeOld = 0;
  if (taxableIncomeOld > 5000000 && taxableIncomeOld <= 10000000)
    surchargeOld = taxOld * 0.1;
  else if (taxableIncomeOld > 10000000 && taxableIncomeOld <= 20000000)
    surchargeOld = taxOld * 0.15;
  else if (taxableIncomeOld > 20000000 && taxableIncomeOld <= 50000000)
  ...
  // Surcharge new
  let surchargeNew = 0;
  if (taxableIncomeNew > 5000000 && taxableIncomeNew <= 10000000)
    surchargeNew = taxBaseNew * 0.1;
  else if (taxableIncomeNew > 10000000 && taxableIncomeNew <= 20000000)
    surchargeNew = taxBaseNew * 0.15;
  else if (taxableIncomeNew > 20000000 && taxableIncomeNew <= 50000000)
    surchargeNew = taxBaseNew * 0.25;
  else if (taxableIncomeNew > 50000000) surchargeNew = taxBaseNew * 0.37;
  ...
  const inputProps = { placeholderTextColor: '#999999', keyboardType: 'numeric' };
      ...
      case 2:
        return (
          <>
            ...
            <Text style={[styles.label, appStyle.labelco]}>
              Income from Salary (before HRA, LTA)
            </Text>
            <ThemedTextInput
              {...inputProps}
              placeholder="Income from Salary (before HRA, LTA)"
              value={formatIndianCurrency(form.incomeSalary)}
              onChangeText={(text) =>
                handleInputChange('incomeSalary', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.specialAllowance)}
              onChangeText={(text) =>
                handleInputChange('specialAllowance', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.bonus)}
              onChangeText={(text) =>
                handleInputChange('bonus', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.childrenEducation)}
              onChangeText={(text) =>
                handleInputChange('childrenEducation', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.telecom)}
              onChangeText={(text) =>
                handleInputChange('telecom', (text || '').replace(/,/g, ''))
              }
            />

            <Text style={[styles.label, appStyle.labelco]}>
              Other Allowances (Fuel, Driver, Attire)
            </Text>
            <ThemedTextInput
              {...inputProps}
              placeholder="Other Allowances"
              value={formatIndianCurrency(form.otherAllowances)}
              onChangeText={(text) =>
                handleInputChange('otherAllowances', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.rentalIncome)}
              onChangeText={(text) =>
                handleInputChange('rentalIncome', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.incomeDigitalAssets)}
              onChangeText={(text) =>
                handleInputChange('incomeDigitalAssets', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.interestIncome)}
              onChangeText={(text) =>
                handleInputChange('interestIncome', (text || '').replace(/,/g, ''))
              }
            />

            <Text style={[styles.label, appStyle.labelco]}>
              Other Income (Freelancing, Perks)
            </Text>
            <ThemedTextInput
              {...inputProps}
              placeholder="Other Income"
              value={formatIndianCurrency(form.otherIncome)}
              onChangeText={(text) =>
                handleInputChange('otherIncome', (text || '').replace(/,/g, ''))
              }
            />

            <Text style={[styles.label, appStyle.labelco]}>
              Perquisite Income (House, Loan, etc.)
            </Text>
            <ThemedTextInput
              {...inputProps}
              placeholder="Perquisite Income"
              value={formatIndianCurrency(form.perquisiteIncome)}
              onChangeText={(text) =>
                handleInputChange('perquisiteIncome', (text || '').replace(/,/g, ''))
              }
            />
          </>
        );
        ...
        return (
          <>
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.hraReceived)}
              onChangeText={(text) =>
                handleInputChange('hraReceived', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.ltaClaimed)}
              onChangeText={(text) =>
                handleInputChange('ltaClaimed', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.professionalTax)}
              onChangeText={(text) =>
                handleInputChange('professionalTax', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <Text style={[styles.label, appStyle.labelco]}>
              Other Reimbursements (Fuel, Driver, Internet, etc.)
            </Text>
            <ThemedTextInput
              {...inputProps}
              placeholder="Other Reimbursements"
              value={formatIndianCurrency(form.otherReimbursements)}
              onChangeText={(text) =>
                handleInputChange('otherReimbursements', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.homeLoanSelf)}
              onChangeText={(text) =>
                handleInputChange('homeLoanSelf', (text || '').replace(/,/g, ''))
              }
            />
          </>
        );
        ...
        return (
          <>
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.tuitionFees)}
              onChangeText={(text) =>
                handleInputChange('tuitionFees', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.postOffice)}
              onChangeText={(text) =>
                handleInputChange('postOffice', (text || '').replace(/,/g, ''))
              }
            />

            <Text style={[styles.label, appStyle.labelco]}>
              Tax Saver Fixed Deposit (5-Year FD)
            </Text>
            <ThemedTextInput
              {...inputProps}
              placeholder="Tax Saver FD"
              value={formatIndianCurrency(form.taxSaverFd)}
              onChangeText={(text) =>
                handleInputChange('taxSaverFd', (text || '').replace(/,/g, ''))
              }
            />

            <Text style={[styles.label, appStyle.labelco]}>
              Jeevan Suraksha Scheme (JSS)
            </Text>
            <ThemedTextInput
              {...inputProps}
              placeholder="JSS"
            ...
            <ThemedTextInput
              ...
              value={formatIndianCurrency(form.homeLoanPrincipal)}
              onChangeText={(text) =>
                handleInputChange('homeLoanPrincipal', (text || '').replace(/,/g, ''))
              }
            />
          </>
        );
          ...
          <>
            ...
            <View style={styles.summaryCard}>
              <Text style={styles.sectionHeading}>
                80C – Investment-Based Deductions
              </Text>
              <Text>
                Total Declared: ₹{raw80C.toLocaleString()} / ₹1,50,000
              </Text>
              <TouchableOpacity onPress={() => setStep(4)} style={styles.linkButton}>
                <Text style={styles.linkText}>View / Edit 80C Details</Text>
              </TouchableOpacity>
            ...
            <Text style={[styles.label, appStyle.labelco]}>
              80D – Medical Insurance & Preventive Checkup
            </Text>
            <ThemedTextInput
              {...inputProps}
              placeholder="80D"
              value={formatIndianCurrency(form.deduction80D)}
              onChangeText={(text) =>
                handleInputChange('deduction80D', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              {...inputProps}
              placeholder="80E"
              value={formatIndianCurrency(form.deduction80E)}
              onChangeText={(text) =>
                handleInputChange('deduction80E', (text || '').replace(/,/g, ''))
              }
            />

            <Text style={[styles.label, appStyle.labelco]}>
              80CCD(1B) – Employee Voluntary NPS Contribution
            </Text>
            <ThemedTextInput
              {...inputProps}
              placeholder="80CCD(1B)"
              value={formatIndianCurrency(form.deduction80CCD1B)}
              onChangeText={(text) =>
                handleInputChange('deduction80CCD1B', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              {...inputProps}
              placeholder="80TTA"
              value={formatIndianCurrency(form.deduction80TTA)}
              onChangeText={(text) =>
                handleInputChange('deduction80TTA', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              {...inputProps}
              placeholder="80G"
              value={formatIndianCurrency(form.deduction80G)}
              onChangeText={(text) =>
                handleInputChange('deduction80G', (text || '').replace(/,/g, ''))
              }
            />

            <Text style={[styles.label, appStyle.labelco]}>
              80U / 80DD – Disability Deduction
            </Text>
            <ThemedTextInput
              {...inputProps}
              placeholder="80U / 80DD"
              value={formatIndianCurrency(form.deduction80U)}
              onChangeText={(text) =>
                handleInputChange('deduction80U', (text || '').replace(/,/g, ''))
              }
            />
            ...
            <ThemedTextInput
              {...inputProps}
              placeholder="Other Deductions (Optional Label)"
              value={formatIndianCurrency(form.deductionOther)}
              onChangeText={(text) =>
                handleInputChange('deductionOther', (text || '').replace(/,/g, ''))
              }
            />
          </>
        );
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={styles.row}>
                  ...
                  <View style={[styles.boderBox, { borderColor: '#f1b500' }]}>
                    ...
                    >
                      ...
                      <View style={{ marginTop: 10 }}>
                        {rowKV('Income tax', taxOld.toLocaleString())}
                        {rowKV('Surcharge', surchargeOld.toLocaleString())}
                        {rowKV('Cess', cessOld.toLocaleString())}
                      </View>
                    </View>

                    <View style={{ flexDirection: 'column' }}>
                      <View style={styles.kpiPill}>
                        <Text style={styles.kpiSmall}>Total income</Text>
                        <Text style={styles.kpiSmallBold}>
                          ₹{taxableIncomeOld.toLocaleString()}
                        </Text>
                      </View>

                      <View style={styles.kpiPill}>
                        <Text style={styles.kpiSmall}>Exemption and deduction</Text>
                        <Text style={styles.kpiSmallBold}>
                          ₹{totalDeductionsOld.toLocaleString()}
                        </Text>
                      </View>
                    </View>

                    <Text style={styles.effectiveRate}>
                      Effective Tax Rate {safePct(taxOld, grossIncome)}%
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.taxBox}>
                  ...
                  <View
                    style={[
                      styles.boderBox,
                      { borderColor: '#3DA14F', backgroundColor: '#F2F8F3' },
                    ]}
                  >
                    <View
                      style={{
                        backgroundColor: '#C2E5C8',
                        padding: 10,
                        marginBottom: 10,
                        borderRadius: 10,
                      }}
                    >
                      ...
                      <View style={{ marginTop: 10 }}>
                        {rowKV('Income tax', taxBaseNew.toLocaleString())}
                        {rowKV('Surcharge', surchargeNew.toLocaleString())}
                        {rowKV('Cess', cessNew.toLocaleString())}
                      </View>
                    </View>

                    <View style={{ flexDirection: 'column' }}>
                      <View style={[styles.kpiPill, { backgroundColor: '#E5E5E5' }]}>
                        <Text style={styles.kpiSmall}>Total income</Text>
                        <Text style={styles.kpiSmallBold}>
                          ₹{taxableIncomeNew.toLocaleString()}
                        </Text>
                      </View>
                      ...
                      <View style={[styles.kpiPill, { backgroundColor: '#E5E5E5' }]}>
                        <Text style={styles.kpiSmall}>Exemption and deduction</Text>
                        <Text style={styles.kpiSmallBold}>
                          ₹{standardDeductionNew.toLocaleString()}
                        </Text>
                      </View>
                    </View>

                    <Text style={styles.effectiveRate}>
                      Effective Tax Rate {safePct(taxBaseNew, grossIncome)}%
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.cardContainerresult}>
                ...
                {[
                  ...
                  <View key={index} style={{ marginVertical: 6 }}>
                    <Text>
                      {item.label} ₹{item.used.toLocaleString()} of ₹
                      {item.cap.toLocaleString()} declared
                    </Text>
                    <View style={styles.barBackground}>
                      <View
                        style={[
                          styles.barFill,
                          { width: barWidthPct(item.used, item.cap) },
                        ]}
                      />
                    </View>
                  </View>
  ...
  return (
    <View style={{ flexDirection: 'column', flex: 1 }}>
      ...
      >
        ...
        <Text style={{ fontWeight: 'bold', fontSize: 12, color: '#969696' }}>
          Step <Text style={{ color: '#000', fontSize: 16 }}>{step}</Text>/6
        </Text>
        <View style={{ width: 50 }} />
      </View>
...
const styles = StyleSheet.create({
  ...
  kpiSmall: { fontSize: 11 },
  kpiSmallBold: { fontSize: 11, fontWeight: '600' },
  recommendedTag: {
    fontSize: 12,
    backgroundColor: '#349c67',
    paddingHorizontal: 2,
    borderRadius: 4,
    color: '#fff',
  },
  ...
  linkText: { color: '#273283', fontWeight: '600' },
});
