...
const BankAccountSelfEmployedBusiness = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={[styles.container, dynamicStyles]}>
            ...
            >
                <Pressable style={styles.button} onPress={() => navigation.navigate('SelfReasontoApplyforLoan')}>
...
export default BankAccountSelfEmployedBusiness;
