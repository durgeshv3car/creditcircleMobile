...
const StudentBankAccount = ({ navigation }) => {
        ...
        <SafeAreaView style={[styles.container, dynamicStyles]}>
            <View style={styles.scrollContainer}>
                ...
                <View style={appStyle.HeadingTitle}>
                    <ThemedHeadingText style={styles.header}>Saving Bank Account</ThemedHeadingText>
            ...
            >
                <Pressable style={styles.button} onPress={() => navigation.navigate('FamilyDetails')}>
